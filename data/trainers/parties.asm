...
FalknerGroup:
	...
	db  43, XATU,     GOLD_BERRY,   FLY, FAINT_ATTACK, CONFUSE_RAY, PSYCHIC_M
...
WhitneyGroup:
	...
	db 44, WIGGLYTUFF, 	PINK_BOW, 			DOUBLE_EDGE, THUNDERPUNCH, ICE_PUNCH, SING 
	db 43, GRANBULL,  	QUICK_CLAW,			METRONOME, CRUNCH, TAKE_DOWN, ATTRACT 
...
BugsyGroup:
	...
	db  42, BEEDRILL, 	MINT_BERRY, 	AGILITY, SLUDGE_BOMB, PURSUIT, TWINEEDLE
...
MortyGroup:
	...
	db 46, MISDREAVUS, 	FOCUS_BAND,  		MEAN_LOOK, CURSE, PERISH_SONG, SHADOW_BALL
	db 45, GENGAR, 		BITTER_BERRY,  		CONFUSE_RAY, SHADOW_BALL, FIRE_PUNCH, CURSE 	
	db 43, GIRAFARIG, 	PRZCUREBERRY, 		PSYBEAM, STOMP, SHADOW_BALL, THUNDERBOLT
	db 47, GENGAR, 		KINGS_ROCK,   		HYPNOSIS, DESTINY_BOND, SHADOW_BALL, DREAM_EATER
	db -1 ; end
...
PryceGroup:
	...
	db 44, CLOYSTER, 	LEFTOVERS,  	PROTECT, ICY_WIND, WHIRLPOOL, SPIKES 
	db 46, JYNX, 		MINT_BERRY,  	LOVELY_KISS, PSYCHIC_M, ICY_WIND, BLIZZARD 
	db 44, DEWGONG, 	GOLD_BERRY,  	REST, HEADBUTT, ICE_BEAM, ICY_WIND 
...
JasmineGroup:
	...
	db 47, CORSOLA, 	LEFTOVERS,  	RAIN_DANCE, SURF, ANCIENTPOWER, RECOVER
	db 46, AMPHAROS,  	MINT_BERRY, 	THUNDER, THUNDER_WAVE, LIGHT_SCREEN, IRON_TAIL
	db 45, FORRETRESS,  GOLD_BERRY,  	EXPLOSION, SPIKES, GIGA_DRAIN, RAPID_SPIN
...
ChuckGroup:
	...
	db 43, URSARING, 	QUICK_CLAW,		DYNAMICPUNCH, CRUNCH, SLASH, EARTHQUAKE 
	db 43, HITMONCHAN, 	PSNCUREBERRY, 	DYNAMICPUNCH, MACH_PUNCH, COMET_PUNCH, ICE_PUNCH
	db 45, MACHAMP,		ICE_BERRY,  	DYNAMICPUNCH, CROSS_CHOP, FOCUS_ENERGY, SUBSTITUTE 
...
ClairGroup:
	...
	db 46, DRAGONAIR, 	PRZCUREBERRY, 	OUTRAGE, SLAM, THUNDERBOLT, THUNDER_WAVE
	db 48, DRAGONAIR, 	DRAGON_FANG, 	DRAGONBREATH, HYPER_BEAM, SURF, RAIN_DANCE
	db 46, GYARADOS, 	BITTER_BERRY,	DRAGONBREATH, BITE, THRASH, ICE_BEAM
