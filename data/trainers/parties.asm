...
BugsyGroup:
	...
	db  44, HERACROSS, 	SILVERPOWDER, 	MEGAHORN, REVERSAL, ENDURE, HORN_ATTACK
...
ChuckGroup:
	...
	db 47, POLIWRATH,  	FOCUS_BAND,   	DYNAMICPUNCH, HYDRO_PUMP, PSYCHIC_M, BODY_SLAM
	db -1 ; end
...
LtSurgeGroup:
	...
	db 48, RAICHU, 		BITTER_BERRY,		THUNDER_WAVE, THUNDER, THUNDERBOLT, SEISMIC_TOSS
	...
	db 50, ELECTABUZZ,	BRIGHTPOWDER,  		ICE_PUNCH, PSYCHIC_M, LIGHT_SCREEN, THUNDER 
	db -1 ; end
...
ErikaGroup:
	...
	db 51, BELLOSSOM, 	FOCUS_BAND,			SUNNY_DAY, SYNTHESIS, GIGA_DRAIN, SOLARBEAM
	db -1 ; end
...
JanineGroup:
	...
	db 42, WEEZING, 	BITTER_BERRY,		SLUDGE_BOMB, TOXIC, SWAGGER, ATTRACT 
	db 40, ARIADOS,		PRZCUREBERRY,		SCARY_FACE, GIGA_DRAIN, SPIDER_WEB, TOXIC
...
SabrinaGroup:
	...
	db 52, 	ALAKAZAM,	TWISTEDSPOON,	PSYCHIC_M, RECOVER, SHADOW_BALL, REFLECT
	db -1 ; end
...
BlaineGroup:
	...
	db 53, RAPIDASH, 	BLACKBELT_I,  	HYPNOSIS, FIRE_BLAST, DOUBLE_KICK, AGILITY
	db -1 ; end
...
BlueGroup:
	...
	db 54, ALAKAZAM, 	MIRACLEBERRY,  	FIRE_PUNCH, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYDON,   	GOLD_BERRY,  	FISSURE, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS, 	FOCUS_BAND,  	FLAIL, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
