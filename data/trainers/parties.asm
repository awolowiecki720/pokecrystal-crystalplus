...
FalknerGroup:
	...
	db  41, SKARMORY, PRZCUREBERRY, 	TOXIC, DRILL_PECK, MUD_SLAP, STEEL_WING
	db  42, NOCTOWL,  MINT_BERRY,   	REFLECT, WING_ATTACK, HYPNOSIS, DREAM_EATER
	db  43, FEAROW,   SHARP_BEAK,   	MIRROR_MOVE, DRILL_PECK, MUD_SLAP, SWIFT
	db  43, XATU,     BLACKGLASSES, 	FLY, FAINT_ATTACK, CONFUSE_RAY, PSYCHIC_M
	db  44, PIDGEOT,  PINK_BOW,     	FLY, DOUBLE_EDGE, QUICK_ATTACK, MUD_SLAP
	db -1 ; end
...
WhitneyGroup:
	...
	db 44, WIGGLYTUFF, 	POLKADOT_BOW, 		DOUBLE_EDGE, THUNDERPUNCH, ICE_PUNCH, SING 
	db 43, GRANBULL,  	MINT_BERRY,			METRONOME, CRUNCH, TAKE_DOWN, ATTRACT 
	db 45, CLEFABLE, 	MIRACLEBERRY, 		METRONOME, SWEET_KISS, BODY_SLAM, ROLLOUT
	db 46, MILTANK, 	LEFTOVERS, 			BODY_SLAM, MILK_DRINK, ROLLOUT, ATTRACT 
	db 43, TAUROS, 		BITTER_BERRY,		THRASH, HEADBUTT, SWAGGER, EARTHQUAKE
	db -1 ; end
...
BugsyGroup:
	...
	db  42, BEEDRILL, 	PRZCUREBERRY, 	AGILITY, SLUDGE_BOMB, PURSUIT, TWINEEDLE
	db  43, BUTTERFREE, PSNCUREBERRY, 	SLEEP_POWDER, PSYBEAM, WHIRLWIND, SAFEGUARD
	db  44, PINSIR, 	BITTER_BERRY, 	FURY_CUTTER, SUBMISSION, GUILLOTINE, BIND
	db  44, HERACROSS, 	FOCUS_BAND, 	MEGAHORN, REVERSAL, ENDURE, HORN_ATTACK
	db  46, SCYTHER, 	SCOPE_LENS, 	FURY_CUTTER, SWORDS_DANCE, SLASH, WING_ATTACK
	db -1 ; end
...
MortyGroup:
	...
	db 44, STANTLER, 	PINK_BOW,			HYPNOSIS, HEADBUTT, CONFUSE_RAY, SPITE 
	db 46, MISDREAVUS, 	SPELL_TAG,  		MEAN_LOOK, PAIN_SPLIT, PERISH_SONG, SHADOW_BALL
	db 45, GENGAR, 		BITTER_BERRY,  		CONFUSE_RAY, SHADOW_BALL, DESTINY_BOND, CURSE 	
	db 43, GIRAFARIG, 	PRZCUREBERRY, 		PSYBEAM, STOMP, SHADOW_BALL, THUNDERBOLT
	db 47, GENGAR, 		KINGS_ROCK,   		HYPNOSIS, FIRE_PUNCH, SHADOW_BALL, DREAM_EATER
	db -1 ; end
...
PryceGroup:
	...
	db 44, CLOYSTER, 	GOLD_BERRY,  	PROTECT, ICY_WIND, CLAMP, SPIKES 
	db 46, JYNX, 		PRZCUREBERRY,  	LOVELY_KISS, PSYCHIC_M, ICY_WIND, BLIZZARD 
	db 44, DEWGONG, 	MINT_BERRY,  	REST, HEADBUTT, ICE_BEAM, ICY_WIND 
	db 47, SNEASEL, 	NEVERMELTICE,   SLASH, ICY_WIND, SCREECH, FAINT_ATTACK 
	db 48, PILOSWINE, 	QUICK_CLAW,  	EARTHQUAKE, ICY_WIND, BLIZZARD, ANCIENTPOWER 
	db -1 ; end
...
JasmineGroup:
	...
	db 46, MAGNETON,  	BITTER_BERRY,  	THUNDERBOLT, TRI_ATTACK, SCREECH, SUPERSONIC
	db 47, CORSOLA, 	MYSTIC_WATER,  	MIRROR_COAT, SURF, ANCIENTPOWER, RECOVER
	db 46, AMPHAROS,  	BERRY_JUICE, 	THUNDER, THUNDER_WAVE, RAIN_DANCE, IRON_TAIL
	db 45, FORRETRESS,  PRZCUREBERRY,  	EXPLOSION, SPIKES, GIGA_DRAIN, RAPID_SPIN
	db 48, STEELIX, 	QUICK_CLAW,  	SANDSTORM, IRON_TAIL, CURSE, EARTHQUAKE
	db -1 ; end
...
ChuckGroup:
	...
	db 44, PRIMEAPE,  	PRZCUREBERRY,  	DYNAMICPUNCH, SEISMIC_TOSS, COUNTER, ROCK_SLIDE
	db 43, URSARING, 	BITTER_BERRY,	DYNAMICPUNCH, CRUNCH, SLASH, EARTHQUAKE 
	db 43, HITMONCHAN, 	PSNCUREBERRY, 	DYNAMICPUNCH, MACH_PUNCH, COMET_PUNCH, ICE_PUNCH
	db 45, MACHAMP,		GOLD_BERRY,  	DYNAMICPUNCH, CROSS_CHOP, FOCUS_ENERGY, SUBSTITUTE 
	db 47, POLIWRATH,  	BLACKBELT_I,   	DYNAMICPUNCH, HYDRO_PUMP, PSYCHIC_M, BODY_SLAM
	db -1 ; end
...
ClairGroup:
	...
	db 46, DRAGONAIR, 	BITTER_BERRY, 	OUTRAGE, SLAM, THUNDERBOLT, THUNDER_WAVE
	db 48, DRAGONAIR, 	BURNT_BERRY, 	DRAGONBREATH, HYPER_BEAM, SURF, RAIN_DANCE
	db 46, GYARADOS, 	PRZCUREBERRY,	DRAGONBREATH, BITE, HYPER_BEAM, ICE_BEAM
	db 48, LAPRAS, 		MINT_BERRY,  	DRAGONBREATH, REST, ICE_BEAM, SURF
	db 50, KINGDRA,  	SCOPE_LENS,    	DRAGONBREATH, HYDRO_PUMP, HYPER_BEAM, BLIZZARD
	db -1 ; end
...
BrockGroup:
	...
	db 44, RHYDON,  	MINT_BERRY, 	THUNDER, DOUBLE_EDGE, EARTHQUAKE, HORN_DRILL
	db 47, ONIX, 		BITTER_BERRY, 	BIND, ROCK_SLIDE, FISSURE, SANDSTORM
	db 46, KABUTOPS,	PRZCUREBERRY, 	SLASH, SURF, ANCIENTPOWER, GIGA_DRAIN
	db 46, OMASTAR,   	GOLD_BERRY, 	BITE, SURF, ANCIENTPOWER, SPIKE_CANNON
	db 48, GOLEM, 		HARD_STONE, 	DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db -1 ; end
...
MistyGroup:
	...
	db 45, SEAKING, 	GOLD_BERRY, 	HORN_DRILL, HYDRO_PUMP, PECK, AGILITY
	db 46, GOLDUCK,		PRZCUREBERRY, 	HYDRO_PUMP, DISABLE, LIGHT_SCREEN, PSYCHIC_M
	db 46, QUAGSIRE, 	PSNCUREBERRY,	SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 48, LAPRAS,  	MINT_BERRY,		HYDRO_PUMP, PERISH_SONG, BLIZZARD, WHIRLPOOL
	db 51, STARMIE,  	KINGS_ROCK, 	SURF, PSYCHIC_M, RECOVER, ICE_BEAM
	db -1 ; end
...
LtSurgeGroup:
	...
	db 48, RAICHU, 		BITTER_BERRY,		SWEET_KISS, THUNDER, THUNDER_WAVE, REVERSAL
	db 46, LANTURN, 	PSNCUREBERRY, 		THUNDERBOLT, SURF, THUNDER_WAVE, CONFUSE_RAY
	db 46, ELECTRODE, 	PRZCUREBERRY,		SCREECH, DOUBLE_TEAM, THUNDERBOLT, EXPLOSION
	db 46, MAGNETON,  	MAGNET, 			LOCK_ON, DOUBLE_TEAM, TRI_ATTACK, ZAP_CANNON
	db 51, ELECTABUZZ,	BRIGHTPOWDER,  		ICE_PUNCH, PSYCHIC_M, LIGHT_SCREEN, THUNDER 
	db -1 ; end
...
ErikaGroup:
	...
	db 46, TANGELA, 	GOLD_BERRY,			SLEEP_POWDER, AMNESIA, GIGA_DRAIN, BIND
	db 47, JUMPLUFF, 	PRZCUREBERRY,		SLEEP_POWDER, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 48, VILEPLUME,	BITTER_BERRY,		STUN_SPORE, SLUDGE_BOMB, PETAL_DANCE, MOONLIGHT
	db 48, VICTREEBEL, 	POISON_BARB,		SLUDGE_BOMB, POISONPOWDER, SWORDS_DANCE, LEECH_LIFE
	db 51, BELLOSSOM, 	MIRACLEBERRY,		SUNNY_DAY, SYNTHESIS, GIGA_DRAIN, SOLARBEAM
	db -1 ; end
...
SchoolboyGroup:
    ...
    db 34, MR__MIME,   NO_ITEM, PSYCHIC_M, LIGHT_SCREEN, REFLECT, ENCORE
    db 38, MAGNETON,   MAGNET,  ZAP_CANNON, THUNDER_WAVE, LOCK_ON, SWIFT
    db -1 ; end
...
JanineGroup:
	...
	db 42, GLIGAR, 		PSNCUREBERRY,		TOXIC, SLUDGE_BOMB, COUNTER, DOUBLE_TEAM
	db 42, CROBAT,		KINGS_ROCK,			CONFUSE_RAY, BITE, TOXIC, MEAN_LOOK
	db 43, WEEZING, 	BITTER_BERRY,		SLUDGE_BOMB, TOXIC, SWAGGER, ATTRACT 
	db 44, ARIADOS,		PRZCUREBERRY,		SCARY_FACE, GIGA_DRAIN, SPIDER_WEB, TOXIC
	db 46, VENOMOTH, 	SCOPE_LENS,			DOUBLE_TEAM, PSYCHIC_M, FORESIGHT, ATTRACT
	db -1 ; end
...
SabrinaGroup:
	...
	db 49, 	MR__MIME,	BITTER_BERRY,	PSYCHIC_M, BARRIER, LIGHT_SCREEN, BATON_PASS
	db 50,	ESPEON,		PRZCUREBERRY,	PSYCHIC_M, MORNING_SUN, BITE, QUICK_ATTACK
	db 49, 	WOBBUFFET,	BERRY_JUICE,	COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 48, 	HYPNO, 		MINT_BERRY,		HYPNOSIS, DREAM_EATER, FIRE_PUNCH, NIGHTMARE
	db 53, 	ALAKAZAM,	TWISTEDSPOON,	PSYCHIC_M, RECOVER, ICE_PUNCH, REFLECT
	db -1 ; end
...
BugCatcherGroup:
    ...
    db 36, YANMA,      NO_ITEM,      WING_ATTACK, QUICK_ATTACK, DOUBLE_TEAM, SCREECH
	db 40, VENOMOTH,   SILVERPOWDER, GUST, SUPERSONIC, PSYCHIC_M, TOXIC
    db -1 ; end
...
HikerGroup:
    ...
    db 35, PILOSWINE,  NO_ITEM, 	EARTHQUAKE, BLIZZARD, REST, TAKE_DOWN
    db 35, DUGTRIO,    NO_ITEM, 	MAGNITUDE, DIG, MUD_SLAP, SLASH
    db 38, STEELIX,    METAL_COAT, 	DIG, IRON_TAIL, SANDSTORM, SLAM
    db -1 ; end
	...
	db 32, DUNSPARCE,	GLARE, DIG, DEFENSE_CURL, TAKE_DOWN
	db -1 ; end
...
BlaineGroup:
	...
	db 49, MAGMAR, 		BITTER_BERRY, 	THUNDERPUNCH, FIRE_BLAST, SUNNY_DAY, CONFUSE_RAY
	db 50, FLAREON, 	PSNCUREBERRY,  	FIRE_BLAST, SHADOW_BALL, QUICK_ATTACK, IRON_TAIL 
	db 51, MAGCARGO, 	QUICK_CLAW,   	CURSE, EARTHQUAKE, FIRE_BLAST, ROCK_SLIDE
	db 48, WEEZING, 	ICE_BERRY,  	EXPLOSION, FIRE_BLAST, SUNNY_DAY, SMOG
	db 53, RAPIDASH, 	CHARCOAL,  		HYPNOSIS, FIRE_BLAST, DOUBLE_KICK, AGILITY
	db -1 ; end
...
PicnickerGroup:
    ...
    db 33, JUMPLUFF,   NO_ITEM, 		STUN_SPORE, SUNNY_DAY, LEECH_SEED, COTTON_SPORE
    db 33, JUMPLUFF,   NO_ITEM, 		SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, COTTON_SPORE
    db 38, VENUSAUR,   MIRACLE_SEED, 	SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
    db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,  	PRZCUREBERRY,  	STEEL_WING, WHIRLWIND, FLY, MIRROR_MOVE
	db 57, ALAKAZAM, 	MIRACLEBERRY,  	THUNDERPUNCH, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYDON,   	GOLD_BERRY,  	FISSURE, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS, 	MYSTIC_WATER,  	BITE, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 58, EXEGGUTOR,	QUICK_CLAW,  	SUNNY_DAY, LEECH_SEED, PSYCHIC_M, SOLARBEAM
	db 58, ARCANINE, 	PINK_BOW,  		ROAR, BITE, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
