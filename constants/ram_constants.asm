...
; wDailyFlags1::
	...
	const DAILYFLAGS1_WHITNEY_REMATCH				  ; 9  
	const DAILYFLAGS1_BUGSY_REMATCH					  ; 10
	const DAILYFLAGS1_MORTY_REMATCH					  ; 11
	const DAILYFLAGS1_PRYCE_REMATCH					  ; 12
	const DAILYFLAGS1_JASMINE_REMATCH				  ;	13  
	const DAILYFLAGS1_CHUCK_REMATCH					  ; 14
	const DAILYFLAGS1_CLAIR_REMATCH					  ; 15
	const DAILYFLAGS1_BROCK_REMATCH					  ; 16
	const DAILYFLAGS1_MISTY_REMATCH					  ; 17
