...
; BUG_FIX: PRZ and BRN stat reductions now apply to switched Pokémon (see docs/bugs_and_glitches.md)
	call ApplyStatusEffectOnEnemyStats
	ret
...
; Swap badges 3 (PlainBadge) and 5 (MineralBadge).
	...
	ld c, 4
.CheckBadge:
; BUG_FIX: Glacier Badge now boosts Special Defense consistently (see docs/bugs_and_glitches.md)
	ld a, b
	srl b
	push af
	call c, BoostStat
