...
; BUG_FIX: Clear confusion status moved to AI_HealStatus (see docs/bugs_and_glitches.md)
	call AI_HealStatus
	ld a, FULL_RESTORE
	ld [wCurEnemyItem], a
	; fallthrough
...
AI_HealStatus:
; BUG_FIX: AI use of Full Heal or Full Restore will now cure Nightmare status (see docs/bugs_and_glitches.md)
; BUG_FIX: AI use of Full Heal or Full Restore will now cure Attack or Speed drops from burn or paralysis (see docs/bugs_and_glitches.md)
	ld a, [wCurOTMon]
	ld hl, wOTPartyMon1Status
	ld bc, PARTYMON_STRUCT_LENGTH
	call AddNTimes
