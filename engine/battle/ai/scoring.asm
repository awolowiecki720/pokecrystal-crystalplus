...
; BUG_FIX: "Smart" AI now discourages Conversion2 before the first turn (see docs/bugs_and_glitches.md)
	ld a, [wLastPlayerMove]
	and a
	jr z, .discourage
...
; BUG_FIX: "Smart" AI now encourages Mean Look if enemy Pokémon is badly poisoned (see docs/bugs_and_glitches.md)
	ld a, [wPlayerSubStatus5]
	bit SUBSTATUS_TOXIC, a
	jr nz, .encourage
